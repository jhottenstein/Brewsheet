...
describe('Hop Bill Page', function() {
  ...
  describe('Populated Beer Design tests', function() {
    beforeEach(function() {
  ...
  it('should adjust bittering hop due to changes in design IBUs', function() {
    browser().navigateTo('/app/index.html#/beer_design');
    input('og').enter('');
    input('ibu').enter('');
    browser().navigateTo('/app/index.html#/hop_bill');
    ...
    expect(element('tbody tr td:eq(1)', 'Amount value').html()).toBe('0.0');
    expect(element('tbody tr td:eq(4)', 'IBUs value').html()).toBe('0');
